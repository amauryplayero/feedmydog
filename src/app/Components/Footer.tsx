  ...
  return (
    <footer className="flex justify-center items-center bg-transparent text-black h-16">
      ...
      <div className="absolute bottom-0 right-4 overflow-hidden">
       ...
       <Image className={`transition-all w-28 md:w-72 fixed -bottom-14 md:-bottom-36 left-0 pointer-events-none`} src={pattieFooter} alt="patty melt" height={40} width={200}></Image>
      </div>
    </footer>
  )
}
